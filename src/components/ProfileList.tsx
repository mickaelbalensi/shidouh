...
export default function ProfileList() {
  ...
  const viewedProfile = selectedProfile ? state.profiles.find(p => p.id === selectedProfile) : null;
                      ...
                      <div className="flex flex-col space-y-2">
                        <div className="flex space-x-2">
                          <button
                            ...
                            className="flex-1 flex items-center justify-center px-3 py-2 bg-green-50 text-green-600 hover:bg-green-100 rounded-lg transition-colors duration-200 font-medium"
                          >
                            <User size={16} className="mr-2" />
                            Voir profil
                          </button>
                          ...
                          <button
                            onClick={() => {
                              ...
                              dispatch({ type: 'SET_SHOW_APPOINTMENT_FORM', payload: true });
                            }}
                            className="flex-1 flex items-center justify-center px-3 py-2 bg-purple-50 text-purple-600 hover:bg-purple-100 rounded-lg transition-colors duration-200 font-medium"
                          >
                        ...
                        <div className="flex space-x-2">
                          <button
                            ...
                            className="flex-1 flex items-center justify-center px-3 py-2 bg-blue-50 text-blue-600 hover:bg-blue-100 rounded-lg transition-colors duration-200 font-medium"
                          >
                          ...
                          <button
                            ...
                            className="flex items-center justify-center px-3 py-2 bg-red-50 text-red-600 hover:bg-red-100 rounded-lg transition-colors duration-200 font-medium"
                          >
                            <Trash2 size={16} />
                          </button>
                        </div>
